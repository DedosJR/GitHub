...
var Trigger$7 = React2.forwardRef(
  ({ caretPosition = "left", description, icon: Icon2, iconProps, children, ...restProps }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsxs)(AccordionTrigger, { $caretPosition: caretPosition, $size: size, ref: forwardedRef, ...restProps, children: [
      caretPosition === "left" ? (0, import_jsx_runtime2.jsx)(TriggerIcon, { $size: size, children: (0, import_jsx_runtime2.jsx)(ForwardRef$4D, { width: size === "S" ? "1.2rem" : "1.6rem", height: size === "S" ? "1.2rem" : "1.6rem" }) }) : null,
      ...
      caretPosition === "right" ? (0, import_jsx_runtime2.jsx)(TriggerIcon, { $size: size, children: (0, import_jsx_runtime2.jsx)(ForwardRef$4D, { width: size === "S" ? "1.2rem" : "1.6rem", height: size === "S" ? "1.2rem" : "1.6rem" }) }) : null
    ] });
  }
);
...
var AlertIcon = ({ variant: variant2, ...props }) => {
  if (variant2 === "success") {
    return (0, import_jsx_runtime2.jsx)(ForwardRef$4n, { ...props });
  }
  if (variant2 === "danger" || variant2 === "warning") {
    return (0, import_jsx_runtime2.jsx)(ForwardRef$3, { ...props });
  }
  return (0, import_jsx_runtime2.jsx)(ForwardRef$2x, { ...props });
};
      ...
      children: [
        ...
        (0, import_jsx_runtime2.jsx)(
          CloseButton,
          {
            ...
            onClick: onClose,
            color: "neutral700",
            children: (0, import_jsx_runtime2.jsx)(AccessibleIcon, { label: closeLabel, children: (0, import_jsx_runtime2.jsx)(ForwardRef$3V, {}) })
          }
        )
      ]
    }
...
var Link = forwardRef3(
  ({ children, href, disabled = false, startIcon, endIcon, isExternal = false, ...props }, ref) => {
    return (0, import_jsx_runtime2.jsxs)(LinkWrapper$1, { ref, href, disabled, isExternal, ...props, children: [
      ...
      endIcon,
      href && !endIcon && isExternal && (0, import_jsx_runtime2.jsx)(ForwardRef$3t, {})
    ] });
  }
);
...
var MenuTrigger = React2.forwardRef(
  ({ label, endIcon = (0, import_jsx_runtime2.jsx)(ForwardRef$4D, { width: "1.2rem", height: "1.2rem", "aria-hidden": true }), tag = Button, icon, ...rest }, ref) => {
    const props = {
      ...rest,
      ref,
      type: "button"
    };
    return (0, import_jsx_runtime2.jsx)($d08ef79370b62062$export$41fb9f06171c75f4, { asChild: true, children: tag === IconButton ? (0, import_jsx_runtime2.jsx)(IconButton, { label, variant: "tertiary", ...props, children: icon }) : (0, import_jsx_runtime2.jsx)(Button, { endIcon, variant: "ghost", ...props }) });
  }
);
  ...
  return (0, import_jsx_runtime2.jsx)($d08ef79370b62062$export$2ea8a7a591ac5eac, { asChild: true, disabled, children: (0, import_jsx_runtime2.jsxs)(
    SubmenuTrigger,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime2.jsx)(ForwardRef$4h, { fill: "neutral500", height: "1.2rem", width: "1.2rem" })
      ]
    }
  ) });
});
        ...
        CarouselGrid,
        {
          ...
          children: [
            childrenArray && childrenArray.length > 1 && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
              (0, import_jsx_runtime2.jsx)(CarouselAction, { tag: "button", onClick: onPrevious, $area: "startAction", ref: prevActionRef, type: "button", children: (0, import_jsx_runtime2.jsx)(AccessibleIcon, { label: previousLabel, children: (0, import_jsx_runtime2.jsx)(ForwardRef$4j, { width: "1.6rem", height: "1.6rem", fill: "neutral600" }) }) }),
              (0, import_jsx_runtime2.jsx)(CarouselAction, { tag: "button", onClick: onNext, $area: "endAction", ref: nextActionRef, type: "button", children: (0, import_jsx_runtime2.jsx)(AccessibleIcon, { label: nextLabel, children: (0, import_jsx_runtime2.jsx)(ForwardRef$4h, { width: "1.6rem", height: "1.6rem", fill: "neutral600" }) }) })
            ] }),
            ...
            (0, import_jsx_runtime2.jsxs)(Flex, { tag: "span", gap: 3, children: [
              internalTextValue && onClear ? (0, import_jsx_runtime2.jsx)(
                IconBox$3,
                {
                  ...
                  title: clearLabel,
                  ref: clearRef,
                  children: (0, import_jsx_runtime2.jsx)(ForwardRef$3V, {})
                }
              ) : null,
              (0, import_jsx_runtime2.jsx)(DownIcon$1, { children: (0, import_jsx_runtime2.jsx)(ForwardRef$4D, { fill: "neutral500" }) })
            ] })
          ] }),
      ...
      StyledTrigger,
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime2.jsxs)(Flex, { tag: "span", gap: 3, children: [
            ...
            (0, import_jsx_runtime2.jsx)(DownIcon, { children: (0, import_jsx_runtime2.jsx)(ForwardRef$4D, {}) })
          ] })
        ]
      }
    ) });
      ...
      DatePickerProvider,
      {
        ...
        children: [
          (0, import_jsx_runtime2.jsxs)(DatePickerTrigger, { className, hasError, size, children: [
            (0, import_jsx_runtime2.jsx)(ForwardRef$4H, { fill: "neutral500", "aria-hidden": true }),
  ...
  ({ step = 15, value: valueProp, defaultValue, onChange, ...restProps }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(
      Combobox2,
      {
        ...
        autocomplete: "none",
        startIcon: (0, import_jsx_runtime2.jsx)(ForwardRef$4d, { fill: "neutral500" }),
        inputMode: "numeric",
  ...
  ({ children, closeLabel = "Close modal", ...restProps }, forwardedRef) => {
    return (0, import_jsx_runtime2.jsxs)(
      Head,
      {
        ...
        children: [
          children,
          (0, import_jsx_runtime2.jsx)(Close, { children: (0, import_jsx_runtime2.jsx)(IconButton, { withTooltip: false, label: closeLabel, children: (0, import_jsx_runtime2.jsx)(ForwardRef$3V, {}) }) })
        ]
      }
    );
  }
        ...
        endAction: (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", children: [
          (0, import_jsx_runtime2.jsx)(
            ArrowButton,
            {
              ...
              type: "button",
              "data-testid": "ArrowUp",
              children: (0, import_jsx_runtime2.jsx)(ForwardRef$4D, { fill: "neutral500" })
            }
          ),
          (0, import_jsx_runtime2.jsx)(
            ArrowButton,
...
var PreviousLink = forwardRef3(
  ({ children, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime2.jsxs)(ActionLinkWrapper, { ref, "aria-disabled": disabled, tabIndex: disabled ? -1 : void 0, ...props, children: [
      (0, import_jsx_runtime2.jsx)(VisuallyHidden, { children }),
      (0, import_jsx_runtime2.jsx)(ForwardRef$4j, { "aria-hidden": true })
    ] });
  }
);
var NextLink = forwardRef3(
  ({ children, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime2.jsxs)(ActionLinkWrapper, { ref, "aria-disabled": disabled, tabIndex: disabled ? -1 : void 0, ...props, children: [
      (0, import_jsx_runtime2.jsx)(VisuallyHidden, { children }),
      (0, import_jsx_runtime2.jsx)(ForwardRef$4h, { "aria-hidden": true })
    ] });
  }
);
...
var CloseIcon = dt(ForwardRef$3V)`
  font-size: 0.5rem;
  path {
      ...
      if (arg && typeof arg === "object" && arg.value) {
        return (0, import_jsx_runtime2.jsx)(
          Tag,
          {
            tabIndex: -1,
            disabled,
            icon: (0, import_jsx_runtime2.jsx)(ForwardRef$3V, { width: `${14 / 16}rem`, height: `${14 / 16}rem` }),
...
@strapi/design-system/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-YWBONKD5.js.map
