...
const SvgIcon = () => /* @__PURE__ */ jsx(
  "svg",
  {
    ...
    children: /* @__PURE__ */ jsxs("g", { fill: "none", "fill-rule": "evenodd", children: [
      /* @__PURE__ */ jsx(
        "path",
        {
...
const CKEditorIcon = () => /* @__PURE__ */ jsx(
  IconBox,
  {
...
const index = {
  async register(app) {
    app.customFields.register({
      ...
      components: {
        Input: async () => import("./index-CPBrnTwd.mjs")
      },
      options: {
        base: [
          {
...
//# sourceMappingURL=index-BZZiYjTp.mjs.map
